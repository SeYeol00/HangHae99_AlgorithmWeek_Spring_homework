...
1. transport란 추상 클래스 구현, Bus 클래스와 Taxi 클래스의 공통 필드와 매서드를 추상으로 묶어줌
2. 하위 클래스로 Bus 클래스와 Taxi 클래스 구현
3. 각각의 클래스들의 필드를 private으로 선언한 위 생성자, 접근자, 설정자를 모든 필드에 설정하여 메서드에서만 접근하도록 만듬
